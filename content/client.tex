...
\begin{frame}{Models}
  ...
  \begin{block}{Methoden}
    \begin{itemize}
      \item \texttt{get}, \texttt{set}, \texttt{has}, \texttt{unset}
      \item \texttt{fetch}, \texttt{save}, \texttt{destroy}
      \item \texttt{parse}, \texttt{toJSON}
    \end{itemize}
  \end{block}
  
  \begin{block}{Ereignisse}
    \begin{itemize}
      \item \texttt{change}, \texttt{attribute:change}
      \item \texttt{destroy}
    \end{itemize}
  \end{block}
\end{frame}
